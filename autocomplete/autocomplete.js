...
this.primevue.autocomplete = (function (utils, OverlayEventBus, Button, Ripple, VirtualScroller, Portal, vue) {
    ...
    const _hoisted_2 = ["value", "aria-controls", "aria-activedescendant"];
    const _hoisted_3 = { class: "p-autocomplete-token-label" };
    const _hoisted_4 = ["onClick"];
    const _hoisted_5 = { class: "p-autocomplete-input-token" };
    const _hoisted_6 = ["aria-controls", "aria-activedescendant"];
    const _hoisted_7 = ["id"];
    const _hoisted_8 = ["id", "onClick", "data-index"];
